...
const InvoiceDetailsActions: FC<IProps> = ({ invoice, isShowOrdersPosition, handleIsShowOrdersPositionChange }) => {
      ...
      <Grid xs={6}>
        <Stack spacing={matches_700 ? 2 : 1} sx={{ width: "100%" }}>
          ...
          <Stack direction={ROW} spacing={2}>
            {paid && !paid.isPaid && <InvoiceDetailsCancel id={id} cancel={cancel} paid={paid} />}
