...
const MachineryStatusButtons: FC = () => {
    ...
    return (
        <ButtonGroup variant="outlined" aria-label="Basic button group">
            <Button color={currentMachinery.status === MachineryStatus.disActive ? "error" : "primary"}
            ...
            <Button color={currentMachinery.status === MachineryStatus.active ? "success" : "primary"}
