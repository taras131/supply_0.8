...
const ProblemAddNew: FC<IProps> = ({ isOpen, onClose }) => {
  ...
  const { editedValue, errors, handleFieldChange, resetValue } = useEditor<INewProblem>({
    ...
    <Drawer anchor="right" open={isOpen} onClose={onClose}>
      ...
      >
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between">
          ...
          <Button onClick={addClickHandler} variant="contained" color="success" disabled={!!Object.keys(errors).length}>
            Сохранить
          </Button>
        </Stack>
      </Box>
