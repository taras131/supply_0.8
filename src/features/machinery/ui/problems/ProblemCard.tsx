...
import { fetchDeleteProblemPhoto, fetchUpdateMachineryProblem, fetchUploadProblemPhoto } from "../../model/actions";
...
const ProblemCard: FC<IProps> = ({ isOpen, onClose, currentProblemId }) => {
  ...
  const { editedValue, errors, handleFieldChange, setEditedValue } = useEditor<IProblem>({
