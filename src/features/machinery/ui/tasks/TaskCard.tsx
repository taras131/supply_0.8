...
const TaskCard: FC<IProps> = ({ task }) => {
  ...
  const handleNavigateToDetails = () => {
    navigate(
      routes.machineryTaskDetails
        .replace(":machineryId", task.machinery_id?.toString() || "")
    ...
    >
      ...
      <CardActions sx={{ p: 2 }}>
        <Stack sx={{ width: "100%" }} direction="row" alignItems="center" justifyContent="space-between">
          ...
          <Button size="small" variant="outlined" onClick={handleNavigateToDetails} endIcon={<MoreHorizIcon />}>
            Подробнее
          </Button>
        </Stack>
      </CardActions>
