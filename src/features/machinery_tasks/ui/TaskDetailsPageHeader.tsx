    ...
    return (
        <Stack direction="row" alignItems="center" justifyContent="space-between">
            ...
            <ButtonGroup size="small" aria-label="Small button group">
                <Button variant={currentTask.status_id === 1 ? "contained" : "outlined"}
                        onClick={() => statusChangeHandler(1)}>
                    Новая
                </Button>
                <Button variant={currentTask.status_id === 2 ? "contained" : "outlined"}
                        onClick={() => statusChangeHandler(2)}>
                    В работе
                </Button>
                <Button variant={currentTask.status_id === 3 ? "contained" : "outlined"}
